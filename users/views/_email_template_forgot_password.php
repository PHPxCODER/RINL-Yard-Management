				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
					<tr>
						<td align="center" bgcolor="#010e28" style="padding: 40px 0 30px 0; color: #010e28; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
							<img src="https://codevizag.com/users/images/rinlmail_logo.jpg" alt="Codevizag Academy" width="300" height="230" style="display: block;" />
						</td>
					</tr>
					<tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										  <p><?=lang("EML_WHY")?></p>
  <p><?=lang("EML_HOW")?></p>
  <p><a href="<?php echo $results->verify_url."forgot_password_reset.php?email=".$email."&vericode=$vericode&reset=1"; ?>" class="nounderline"><?=lang("PW_RESET");?></a></p>
